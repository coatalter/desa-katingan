        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form action="{{ route('admin.galeri.update', $galeri) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <img src="{{ asset('storage/' . $galeri->gambar) }}" alt="Preview" class="h-40 w-auto rounded-lg shadow-sm object-cover">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3"
                              class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary-500 focus:border-primary-500">{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
